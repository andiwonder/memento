class SearchController < ApplicationController
	...
	def game
		result = HTTParty.get('http://www.giantbomb.com/api/games/?api_key=9a1589bbea869535bbf2840478d5656d7d53eb5c&format=json&field_list=name,image,id&sort=id:desc',
    headers:{
